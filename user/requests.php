...
<?php
    ...
    $selectprop = $conn->query("SELECT *, props.name AS name FROM props, requests where props.id=requests.prop_id and requests.user_id='$user_id'");
    $selectprop->execute();
...
<?php else : ?>
    <div class="text-black mt-3 mb-3">You have not sent any requests yet</div>
<?php endif; ?>
