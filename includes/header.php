...
define("APPURL", "http://localhost/homeland"); //specify the base directory
...
//require "../config/config.php"; //this doesnot work beacuse you are directed here from the header. if you use '..' again you will be directed out of the homeland folder
require dirname(dirname(__FILE__))."/config/config.php";  //This works because the location dirname is not dependent on the location of index
              ...
              <nav class="site-navigation text-right text-md-right" role="navigation">
                ...
                <ul class="site-menu js-clone-nav d-none d-lg-block">
                  ...
                  <li class="has-children">
                    ...
                    <ul class="dropdown arrow-top">
                      <li><a href="<?php echo APPURL; ?>/user/favourites.php?user_id=<?php echo $_SESSION['user_id'];?>">Your Favourites</a></li>
                      <li><a href="<?php echo APPURL; ?>/user/requests.php?user_id=<?php echo $_SESSION['user_id'];?>">Your Requests</a></li>
